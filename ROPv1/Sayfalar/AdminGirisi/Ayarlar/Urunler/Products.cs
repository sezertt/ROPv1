...
namespace ROPv1
{
    public partial class Products : UserControl
    {
        ...
        private void saveProductButtonPressed(object sender, EventArgs e)
        {
            ...
            string urunAdi = textboxUrunName.Text, urunTuru = comboTur.Text, urunKategorisi = comboNewKategoriName.Text, urunPorsiyonFiyati = textboxUrunPorsiyonFiyat.Text.Substring(0, textboxUrunPorsiyonFiyat.Text.Length - 3), urunKiloFiyati = textboxUrunKiloFiyat.Text.Substring(0, textboxUrunKiloFiyat.Text.Length - 3);
